...
//     private final PID rotate_pid = new PID(
//         Constants.DriveConstants.note_rotation_p, 
//         Constants.DriveConstants.note_rotation_i, 
//         Constants.DriveConstants.note_rotation_d
//     );

//     private final PID movement_pid = new PID(
//         Constants.DriveConstants.note_movement_p, 
...
//     public GetNoteCommand(Drive drive, Intake intake) {
//         this.drive = drive;
//         this.intake = intake;
